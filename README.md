...
- แปลข้อความภายในเครื่องด้วยพจนานุกรมตัวอย่างในแอพ เพื่อให้ build ได้โดยไม่พึ่ง service/API ภายนอก
...
> หมายเหตุ: เวอร์ชันนี้ใช้พจนานุกรมตัวอย่างในเครื่องเพื่อให้ workflow สร้าง IPA ได้เสถียร หากต้องการคุณภาพระดับ production สามารถต่อยอดด้วย translation engine แบบ on-device ภายหลัง
